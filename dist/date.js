...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.tai_date = factory();
})(undefined, function () {
    'use strict';
    ...
    var Schedule = function Schedule(opt) {
    ...
    Schedule.prototype.init = function () {
        var _params = params,
            ...
            month = _params.month,
            day = _params.day,
            selectedDate = _params.selectedDate,
            currentYear = _params.currentYear,
            currentMonth = _params.currentMonth,
            currentDay = _params.currentDay,
            el = _params.el,
            _this = _params._this;


        var scheduleHd = '<div class="schedule-hd">' + '<div>' + '<span class="arrow icon iconfont icon-116leftarrowheads" id="prevYear" ></span>' + '<span class="arrow icon iconfont icon-112leftarrowhead" id="prevMonth"></span>' + '</div>' + '<div class="today">' + formartDate(year, month, day, '-') + '</div>' + '<div>' + '<span class="arrow icon iconfont icon-111arrowheadright" id="nextMonth"></span>' + '<span class="arrow icon iconfont icon-115rightarrowheads" id="nextYear"></span>' + '</div>' + '</div>';
    ...
    Schedule.prototype.renderDate = function () {
        var _params2 = params,
            year = _params2.year,
            month = _params2.month,
            day = _params2.day,
            selectedDate = _params2.selectedDate,
            currentYear = _params2.currentYear,
            currentMonth = _params2.currentMonth,
            currentDay = _params2.currentDay,
            el = _params2.el,
            _this = _params2._this;
        // debugger

        var fullDay = getCurrentMonthDateCount(year, month),
            //当月总天数
        startWeek = getWeekDay(year, month, 1),
            //当月第一天是周几
        total = (fullDay + startWeek) % 7 == 0 ? fullDay + startWeek : fullDay + startWeek + (7 - (fullDay + startWeek) % 7),
            //元素总个数
        lastMonthDay = getCurrentMonthDateCount(year, month - 1),
            //上月最后一天
        eleTemp = [];
    ...
    Schedule.prototype.bindEvent = function () {
        var _params3 = params,
            year = _params3.year,
            month = _params3.month,
            day = _params3.day,
            selectedDate = _params3.selectedDate,
            currentYear = _params3.currentYear,
            currentMonth = _params3.currentMonth,
            currentDay = _params3.currentDay,
            el = _params3.el,
            _this = _params3._this,
            opt = _params3.opt;
    ...
    Schedule.prototype.nextMonthFun = function () {
        var _params4 = params,
            year = _params4.year,
            month = _params4.month,
            day = _params4.day,
            selectedDate = _params4.selectedDate,
            currentYear = _params4.currentYear,
            currentMonth = _params4.currentMonth,
            currentDay = _params4.currentDay,
            el = _params4.el,
            _this = _params4._this,
            opt = _params4.opt;
    ...
    Schedule.prototype.nextYearFun = function () {
        var _params5 = params,
            year = _params5.year,
            month = _params5.month,
            day = _params5.day,
            selectedDate = _params5.selectedDate,
            currentYear = _params5.currentYear,
            currentMonth = _params5.currentMonth,
            currentDay = _params5.currentDay,
            el = _params5.el,
            _this = _params5._this,
            opt = _params5.opt;
    ...
    Schedule.prototype.prevMonthFun = function () {
        var _params6 = params,
            year = _params6.year,
            month = _params6.month,
            day = _params6.day,
            selectedDate = _params6.selectedDate,
            currentYear = _params6.currentYear,
            currentMonth = _params6.currentMonth,
            currentDay = _params6.currentDay,
            el = _params6.el,
            _this = _params6._this,
            opt = _params6.opt;
    ...
    Schedule.prototype.prevYearFun = function () {
        var _params7 = params,
            year = _params7.year,
            month = _params7.month,
            day = _params7.day,
            selectedDate = _params7.selectedDate,
            currentYear = _params7.currentYear,
            currentMonth = _params7.currentMonth,
            currentDay = _params7.currentDay,
            el = _params7.el,
            _this = _params7._this,
            opt = _params7.opt;
